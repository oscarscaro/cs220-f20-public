...
// EXERCISE
char delete_after(Node *);         // delete node after current, return char
char delete_front(Node **);        // delete first node, if any, return char
...
int delete_rec(Node **, char);   // recursive version
